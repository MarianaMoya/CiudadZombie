...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo("imagenes/bache.png", 500, 280, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 450, 380, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 210, 380, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 500, 330, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 750, 200, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 800, 400, 30, 30, 1),

    new Obstaculo("imagenes/valla_vertical.png", 820,300, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 460,300, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 100,300, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 760,280, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 780,260, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 800,240, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 115,465, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 800,150, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 150,300, 30, 30, 1),


    new Obstaculo("imagenes/auto_verde_abajo.png", 280, 150, 15, 30, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 350, 185, 15, 30, 1,2),
    new Obstaculo("imagenes/auto_verde_abajo.png", 400, 70, 15, 30, 0,2),
    new Obstaculo("imagenes/auto_verde_abajo.png", 350, 300, 15, 30, 1),

    new Obstaculo("imagenes/auto_verde_derecha.png", 400, 450, 30, 15, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 750, 80, 30, 15, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 880, 200, 30, 15, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 420, 480, 30, 15, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 450, 500, 30, 15, 1)
  ],
  ...
  enemigos: [
   new ZombieCaminante('imagenes/zombie1.png', 100, 400, 10, 12, 2, {
      desdeX: 0,  
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
   new ZombieCaminante('imagenes/zombie4.png', 700, 500, 10, 12, 3, {
      desdeX: 0,  
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 500, 150, 10, 15, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie4.png', 400, 155, 10, 10, 4, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 80, 355, 10, 15, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 80, 455, 10, 15, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 50, 90, 15, { 
      desdeX: 0,
      hastaX: 961,
      desdeY: -15,
      hastaY: 600
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 100, 322, 90, 50, 5, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
...
Juego.dibujar = function() {
  ...
  this.dibujarFondo();
   /*Dibujante.dibujarImagen('imagenes/llegada2.jpg',760, 535, 130,30);*/
